...
exports.ExpenseSchema = exports.Expense = exports.PaymentMethod = void 0;
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: PaymentMethod, default: PaymentMethod.CASH }),
    __metadata("design:type", String)
], Expense.prototype, "paymentMethod", void 0);
exports.Expense = Expense = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'expenses' })
], Expense);
exports.ExpenseSchema = mongoose_1.SchemaFactory.createForClass(Expense);
exports.ExpenseSchema.index({ userId: 1, date: -1 });
exports.ExpenseSchema.index({ userId: 1, categoryId: 1 });
exports.ExpenseSchema.index({ userId: 1, title: 'text', description: 'text' });
